# run_unet_cmca_dacutmix_infer.py -- Inference for UNet-CMCA + DACutMix
# =======================================================================
...
#      checkpoints/unet_cmca_dacutmix/BRIGHT (or set MODEL_PATH directly).
#   2. Run: python run_unet_cmca_dacutmix_infer.py
...
# ===== Edit one of these =====
# Example folder name:
#   UNetCMCA_DACutMix_20260602_153000
...
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\unet_cmca_dacutmix\BRIGHT\UNetCMCA_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "unet_cmca_dacutmix")
