# run_deeplabv3plus_cmca_dacutmix_infer.py -- Inference for DeepLabV3Plus-CMCA + DACutMix
# DACutMix is training-time only; inference uses DeepLabV3PlusCMCA.
...
MODEL_PATH = os.path.join(
    ROOT,
    "checkpoints",
    "deeplabv3plus_cmca_dacutmix",
    "BRIGHT",
    RUN_FOLDER,
    "best_model.pth",
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\deeplabv3plus_cmca_dacutmix\BRIGHT\DeepLabV3PlusCMCA_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "deeplabv3plus_cmca_dacutmix")
