# run_deeplabv3plus_dacutmix_infer.py -- Inference for DeepLabV3Plus + DACutMix
# DACutMix is training-time only; inference uses DeepLabV3Plus.
...
MODEL_PATH = os.path.join(
    ROOT,
    "checkpoints",
    "deeplabv3plus_dacutmix",
    "BRIGHT",
    RUN_FOLDER,
    "best_model.pth",
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\deeplabv3plus_dacutmix\BRIGHT\DeepLabV3Plus_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "deeplabv3plus_dacutmix")
