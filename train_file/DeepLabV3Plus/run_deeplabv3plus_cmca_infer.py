# run_deeplabv3plus_cmca_infer.py -- Inference for DeepLabV3Plus-CMCA
...
MODEL_PATH = os.path.join(
    ROOT, "checkpoints", "deeplabv3plus_cmca", "BRIGHT", RUN_FOLDER, "best_model.pth"
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\deeplabv3plus_cmca\BRIGHT\DeepLabV3PlusCMCA_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "deeplabv3plus_cmca")
