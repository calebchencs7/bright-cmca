# run_changemamba_cmca_infer.py -- Inference for ChangeMamba-CMCA
...
MODEL_PATH = os.path.join(
    ROOT, "checkpoints", "changemamba_cmca", "BRIGHT", RUN_FOLDER, "best_model.pth"
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\changemamba_cmca\BRIGHT\ChangeMambaCMCA_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "changemamba_cmca")
