# run_changemamba_dacutmix_infer.py -- Inference for ChangeMamba + DACutMix
# DACutMix is training-time only; inference uses ChangeMamba.
...
MODEL_PATH = os.path.join(
    ROOT,
    "checkpoints",
    "changemamba_dacutmix",
    "BRIGHT",
    RUN_FOLDER,
    "best_model.pth",
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\changemamba_dacutmix\BRIGHT\ChangeMamba_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "changemamba_dacutmix")
