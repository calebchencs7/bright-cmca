# run_changemamba_infer.py -- Inference for ChangeMamba / MambaBDA-Tiny
...
MODEL_PATH = os.path.join(
    ROOT, "checkpoints", "changemamba", "BRIGHT", RUN_FOLDER, "best_model.pth"
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\changemamba\BRIGHT\ChangeMamba_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "changemamba")
