# run_siamattnunet_cmca_dacutmix_infer.py -- Inference for SiamAttnUNet-CMCA + DACutMix
# DACutMix is training-time only; inference uses SiamAttnUNetCMCA.
...
MODEL_PATH = os.path.join(
    ROOT,
    "checkpoints",
    "siamattnunet_cmca_dacutmix",
    "BRIGHT",
    RUN_FOLDER,
    "best_model.pth",
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\siamattnunet_cmca_dacutmix\BRIGHT\SiamAttnUNetCMCA_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "siamattnunet_cmca_dacutmix")
