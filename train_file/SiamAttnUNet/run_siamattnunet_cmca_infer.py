# run_siamattnunet_cmca_infer.py -- Inference for SiamAttnUNet-CMCA
...
MODEL_PATH = os.path.join(
    ROOT, "checkpoints", "siamattnunet_cmca", "BRIGHT", RUN_FOLDER, "best_model.pth"
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\siamattnunet_cmca\BRIGHT\SiamAttnUNetCMCA_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "siamattnunet_cmca")
