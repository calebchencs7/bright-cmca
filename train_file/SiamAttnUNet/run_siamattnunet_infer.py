# run_siamattnunet_infer.py -- Inference for SiamAttnUNet baseline
...
MODEL_PATH = os.path.join(
    ROOT, "checkpoints", "siamattnunet", "BRIGHT", RUN_FOLDER, "best_model.pth"
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\siamattnunet\BRIGHT\SiamAttnUNet_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "siamattnunet")
