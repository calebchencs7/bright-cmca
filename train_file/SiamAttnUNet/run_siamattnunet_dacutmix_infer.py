# run_siamattnunet_dacutmix_infer.py -- Inference for SiamAttnUNet + DACutMix
# DACutMix is training-time only; inference uses SiamAttnUNet.
...
MODEL_PATH = os.path.join(
    ROOT,
    "checkpoints",
    "siamattnunet_dacutmix",
    "BRIGHT",
    RUN_FOLDER,
    "best_model.pth",
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\siamattnunet_dacutmix\BRIGHT\SiamAttnUNet_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "siamattnunet_dacutmix")
