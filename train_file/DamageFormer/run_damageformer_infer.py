# run_damageformer_infer.py -- Inference for DamageFormer baseline
...
MODEL_PATH = os.path.join(
    ROOT, "checkpoints", "damageformer", "BRIGHT", RUN_FOLDER, "best_model.pth"
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\damageformer\BRIGHT\DamageFormer_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "damageformer")
