# run_damageformer_cmca_dacutmix_infer.py -- Inference for DamageFormer-CMCA + DACutMix
# DACutMix is training-time only; inference uses DamageFormerCMCA.
...
MODEL_PATH = os.path.join(
    ROOT,
    "checkpoints",
    "damageformer_cmca_dacutmix",
    "BRIGHT",
    RUN_FOLDER,
    "best_model.pth",
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\damageformer_cmca_dacutmix\BRIGHT\DamageFormerCMCA_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "damageformer_cmca_dacutmix")
