# run_damageformer_cmca_infer.py -- Inference for DamageFormer-CMCA
...
MODEL_PATH = os.path.join(
    ROOT, "checkpoints", "damageformer_cmca", "BRIGHT", RUN_FOLDER, "best_model.pth"
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\damageformer_cmca\BRIGHT\DamageFormerCMCA_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "damageformer_cmca")
