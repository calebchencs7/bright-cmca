# run_damageformer_dacutmix_infer.py -- Inference for DamageFormer + DACutMix
# DACutMix is training-time only; inference uses DamageFormer.
...
MODEL_PATH = os.path.join(
    ROOT,
    "checkpoints",
    "damageformer_dacutmix",
    "BRIGHT",
    RUN_FOLDER,
    "best_model.pth",
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\damageformer_dacutmix\BRIGHT\DamageFormer_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "damageformer_dacutmix")
