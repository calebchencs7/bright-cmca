# run_siamcrnn_cmca_infer.py -- Inference for SiamCRNN-CMCA
...
MODEL_PATH = os.path.join(
    ROOT, "checkpoints", "siamcrnn_cmca", "BRIGHT", RUN_FOLDER, "best_model.pth"
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\siamcrnn_cmca\BRIGHT\SiamCRNNCMCA_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "siamcrnn_cmca")
