# run_siamcrnn_dacutmix_infer.py -- Inference for SiamCRNN + DACutMix
# DACutMix is training-time only; inference uses SiamCRNN.
...
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\siamcrnn_dacutmix\BRIGHT\SiamCRNN_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "siamcrnn_dacutmix")
