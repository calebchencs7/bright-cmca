# run_siamcrnn_cmca_dacutmix_infer.py -- Inference for SiamCRNN-CMCA + DACutMix
# DACutMix is training-time only; inference uses SiamCRNNCMCA.
...
MODEL_PATH = os.path.join(
    ROOT,
    "checkpoints",
    "siamcrnn_cmca_dacutmix",
    "BRIGHT",
    RUN_FOLDER,
    "best_model.pth",
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\siamcrnn_cmca_dacutmix\BRIGHT\SiamCRNNCMCA_DACutMix_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "siamcrnn_cmca_dacutmix")
