# run_siamcrnn_infer.py -- Inference for SiamCRNN baseline
...
MODEL_PATH = os.path.join(
    ROOT, "checkpoints", "siamcrnn", "BRIGHT", RUN_FOLDER, "best_model.pth"
)
# MODEL_PATH = r"E:\haoChen\BRIGHT\checkpoints\siamcrnn\BRIGHT\SiamCRNN_YYYYMMDD_HHMMSS\best_model.pth"

OUTPUT_DIR = os.path.join(ROOT, "infer_results", "siamcrnn")
