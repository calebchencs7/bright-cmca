...
class DeepLabStableCrossModalChangeAttention(CrossModalChangeAttention):
    """CMCA variant used only by DeepLabV3Plus-CMCA for fp16 stability."""
...
class DeepLabV3PlusCMCA(nn.Module):
    def __init__(
        ...
        self.cmca = DeepLabStableCrossModalChangeAttention(
